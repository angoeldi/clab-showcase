...
def build_graph(*, domain_path: str | None = None, tutorial_path: str | None = None, checkpointer: object | None = None):
    domain_path = domain_path or (_env("CLAB_DOMAIN_PATH", "configs/domain.yaml") or "configs/domain.yaml")
    tutorial_path = tutorial_path or (_env("CLAB_TUTORIAL_PATH", "configs/tutorial.yaml") or "configs/tutorial.yaml")
